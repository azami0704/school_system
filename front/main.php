<div class="container">
    ...
    ?>
        ...
        echo "<a href='index.php' class='btn btn-main'>全部</a>";
...
<section class="main">
    ...
    <div class="page-list">
            ...
            <script>
                ...
                pageSet.addEventListener('change',function(e){
                    ...
                    if(url){
                        location.href=`?pageSet=${e.target.value}&code=${url}`;
                    }else{
    ...
    <ul class="pagination">
            ...
            for($i=$pagiStart;$i<=$pageEnd;$i++){
                if($i==$pageActive){
                    echo "<li class='active'><a href='?pageSet={$pageSetting}&page={$i}{$codeForPageChange}'>{$i}</a></li>";
                }else{
